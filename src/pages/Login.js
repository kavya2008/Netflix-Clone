          ...
          <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              <form className='flex flex-col' onSubmit={handlesubmit}>
                <input type='email' autoComplete='email' placeholder='Email' className='rounded bg-gray-800 text-gray-50 mt-6 py-3 px-3' onChange={(e)=>{setemail(e.target.value)}}></input><br></br>
                ...
                <br></br>
                <button className='rounded py-2 px-4 mt-4 text-white font-bold bg-red-600 cursor-pointer hover:bg-red-800'>
                Sign In</button>
